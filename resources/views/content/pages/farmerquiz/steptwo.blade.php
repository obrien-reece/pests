            ...
            <div class="row mt-3">
              <div class="col-md-6">
                <div class="form-group">
                  <select class="js-example-basic-single form-control" name="state" id="pestSelect" style="height: 90px; width: 100%;">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <input type="text" class="form-control" placeholder="Pest Frequency" name="farm_location">
                </div>
              </div>
              ...
              <div class="col-md-6 mt-4">
                <div class="form-group">
                  <input type="text" class="form-control" placeholder="Farm size">
                </div>
              </div>
              <div class="mt-3">
